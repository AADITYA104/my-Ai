---
name: wrap-and-ship-github-task
description: "Finish the current task end-to-end: changelog entry, commit, push, and close the linked GitHub issue if any. Use when a task is done and needs to be wrapped up and shipped."
---
