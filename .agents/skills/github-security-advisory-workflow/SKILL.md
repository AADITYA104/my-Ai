---
name: github-security-advisory-workflow
description: "Draft or update a GitHub security advisory for publication: investigate independently, propose CVSS scoring, draft a publication-ready advisory markdown file, and apply approved updates via the GitHub API. Use when preparing or publishing a security advisory."
---
