---
name: github-pr-structured-review
description: "Review one or more GitHub PRs from their URLs with a structured Good/Bad/Ugly/Tests analysis, reading the full diff and any linked issues first. Use when asked to review a pull request."
---
