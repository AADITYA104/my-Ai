...
description: "Audit changelog entries for all commits since the last release across multiple packages, flag missing entries, and propose a New Features summary. Use when preparing a release and checking changelog completeness."
---
