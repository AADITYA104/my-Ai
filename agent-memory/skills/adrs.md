...
category: general
source: ruflo-main
description: The current plugin (v0.1.0) is a thin wrapper around 23 Playwright-backed MCP tools (`mcp__plugin_ruflo-core_ruflo__browser_*`). Surface inventory:
---
